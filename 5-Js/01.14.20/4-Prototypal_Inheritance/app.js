...
// We can use prototype to add extra properties after we finished our object or constructor definition 
...
function Food(fName, fPrice , iVegan){
    Product.call(this,fName,fPrice) //like in Pbject __proto__ : Product  // 'this' in constructor tells it that this now means Food not Product
    this.category = 'food';
    this.vegan = iVegan;
}
